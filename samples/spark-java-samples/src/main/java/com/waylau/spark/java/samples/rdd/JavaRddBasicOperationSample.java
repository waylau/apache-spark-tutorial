...
public class JavaRddBasicOperationSample {
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("JavaRddBasicOperationSample")// 设置应用名称
        ...
        // 从外部存储系统源创建RDD
        JavaRDD<String> rddFromFextFile = sparkContext.textFile("src/main/resources/JavaWordCountData.txt");
        ...
        List<String> data = Arrays.asList("Hello", "", "World", "Spark", null, "Java");
        JavaRDD<String> linesRDD = sparkContext.parallelize(data);

        // 使用filter操作过滤出非空的字符串
        JavaRDD<String> nonEmptyLinesRDD = linesRDD.filter(line -> line != null && !line.isEmpty());
