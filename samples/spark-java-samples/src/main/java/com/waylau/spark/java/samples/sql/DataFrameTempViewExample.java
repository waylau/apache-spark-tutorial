...
public class DataFrameTempViewExample {
	...
	public static void main(String[] args)
		...
		SparkSession sparkSession = SparkSession.builder()
				.appName("DataFrameTempView") // 设置应用名称
		...
		// 指定列名来查询相应列的数据
		Dataset<Row> sqlDFWithName = sparkSession
				.sql("SELECT name FROM v_people");
		...
		Dataset<Row> sqlDFWithHostPage =
				...
				sparkSession.sql(
						"SELECT homePage FROM global_temp.v_people");
